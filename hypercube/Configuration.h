...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Hypercube
  #define  DEFAULT_bedKp 537.20
  #define  DEFAULT_bedKi 76.25
  #define  DEFAULT_bedKd 946.15
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3                   // James 20/12/17
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X   // James 20/12/17

  // Set the boundaries for probing (where the probe can reach).
  #define PROBE_BED_INSET 5
